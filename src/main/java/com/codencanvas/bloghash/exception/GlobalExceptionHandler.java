...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(BlogHashException.class)
    public ResponseEntity<ApiResponse<Void>> handleBlogHashException(BlogHashException ex) {
        log.debug("BlogHashException: {}", ex.getMessage());
    ...
    public ResponseEntity<ApiResponse<Void>> handleGenericException(Exception ex) {
        log.error("Unhandled exception: ", ex); // full stack trace في الـ logs
        return ResponseEntity
